...
Different meaning (target, trim) can be assigned to the values in the `mode_switch` field as defined in [MARSH_MANUAL_SETPOINT_MODE](./marsh.md#MARSH_MANUAL_SETPOINT_MODE)
